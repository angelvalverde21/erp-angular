export const environment = {
    ...
    apiUrl: 'https://api.macrotechsac.com/api/v1/public',

    apiPublic: 'https://api.macrotechsac.com/api/v1/public',
    apiPrivate: 'https://api.macrotechsac.com/api/v1/private',
    apiDashboard: 'https://api.macrotechsac.com/api/v1/dashboard',
