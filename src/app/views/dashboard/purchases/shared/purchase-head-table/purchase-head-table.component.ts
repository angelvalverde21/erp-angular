...
@Component({
  selector: 'app-purchase-head-table',
  imports: [
    ButtonComponent,
    CommonModule
  ],
  templateUrl: './purchase-head-table.component.html',
  styleUrl: './purchase-head-table.component.scss'
})
export class PurchaseHeadTableComponent {
