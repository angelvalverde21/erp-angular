...
@Component({
  selector: 'app-brand-input',
  imports: [InputGroupComponent, FormsModule],
  templateUrl: './brand-input.component.html',
  styleUrl: './brand-input.component.scss',
    providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => BrandInputComponent),
      multi: true,
    },
  ],
})
export class BrandInputComponent implements OnInit, ControlValueAccessor {
