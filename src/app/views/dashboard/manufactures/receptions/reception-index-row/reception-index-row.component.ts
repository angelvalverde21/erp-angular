...
@Component({
  selector: 'tr[app-reception-index-row]',
  imports: [
    DateShopifyPipe,
    ButtonComponent,
    FontAwesomeModule,
  ...
  templateUrl: './reception-index-row.component.html',
  styleUrl: './reception-index-row.component.scss'
})
export class ReceptionIndexRowComponent {
